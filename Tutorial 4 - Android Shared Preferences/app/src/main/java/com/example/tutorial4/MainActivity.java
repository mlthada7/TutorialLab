...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* Mendeklarasikan dan Melakukan Inisialisasi variable nama dengan Label Nama
        dari Layout MainActivity */
        ...
        /* Mengatur Status dan User yang sedang login menjadi default atau kosong di data Preferences.
        Kemudian menuju ke LoginActivity*/
